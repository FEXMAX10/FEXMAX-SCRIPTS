...
-- God Mode SIN atravesar + Velocidad 24h 
-- 

-- Bypass Anti-Kick ultra seguro (no rompe la ejecución si falla) 
pcall(function() 
...
-- Carga garantizada de Rayfield con sistema Fallback 
local Rayfield 
...
Rayfield:Notify({ 
Title = "God Mode", 
Content = "ON ✓ Sin atravesar el mapa", 
Duration = 4 
}) 
else 
Rayfield:Notify({ 
...
-- VELOCIDAD 
-- === 
MainTab:CreateSection("Velocidad (24 horas)")
...
Name = "Activar Velocidad (24 horas)", 
Callback = function() 
SpeedActive = true 
SpeedEndTime = os.clock() + SPEED_DURATION
  ...
  Rayfield:Notify({
     Title = "Velocidad",
     Content = "Activada: " .. CurrentSpeed .. " por 24h ✓",
     Duration = 4
  })
end, 
})
...
Rayfield:Notify({ 
Title = "Velocidad", 
Content = "Las 24 horas terminaron", 
Duration = 5 
}) 
else 
local character = LocalPlayer.Character 
...
hrp.CFrame = LastSafeCFrame + Vector3.new(0, 4, 0) 
end 
end
